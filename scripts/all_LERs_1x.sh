...
mpirun -np $NUM_CORES ./promatch -e 40 -d 13 -r 0 -ms 100M -hs 100M -ls 100M -p 1 -t MWPM | tee ../AEResults/PER_d13/MWPM/1x/mwpm_d13_r0_1xp.txt
mpirun -np $NUM_CORES ./promatch -e 40 -d 13 -r 1 -ms 100M -hs 100M -ls 100M -p 1 -t MWPM | tee ../AEResults/PER_d13/MWPM/1x/mwpm_d13_r1_1xp.txt
mpirun -np $NUM_CORES ./promatch -e 40 -d 13 -r 2 -ms 100M -hs 100M -ls 100M -p 1 -t MWPM | tee ../AEResults/PER_d13/MWPM/1x/mwpm_d13_r2_1xp.txt
